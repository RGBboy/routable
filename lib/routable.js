...
exports = module.exports = function (route) {
  ...
  that = function (req, res, next) {
    ...
    //
    // Make a copy of the routeToPath to globalRouteToPath
    // @comment: Should this be named something better?
    if (!req.globalRouteToPath) {
      req.globalRouteToPath = req.routeToPath;
    };
